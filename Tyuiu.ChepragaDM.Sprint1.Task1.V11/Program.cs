using Tyuiu.ChepragaDM.Sprint1.Task1.V11.Lib;
namespace Tyuiu.ChepragaDM.Sprint1.Task1.V11
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* данные, вычисляет результат по формуле 5 * x / (6 * y) и печатает его   *");
            ...
            Console.WriteLine("Введите чисто Х: ");
            x = Convert.ToDouble(Console.ReadLine());

            Console.WriteLine("Введите чисто Y: ");
